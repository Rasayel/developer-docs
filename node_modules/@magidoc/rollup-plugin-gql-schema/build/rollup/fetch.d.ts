...
import { type Method } from '../schema/query.js';
import { type OutputFormat } from '../schema/convert.js';
export type { Method };
...
export declare function fetchSchema(options: PluginOptions): Promise<void>;
